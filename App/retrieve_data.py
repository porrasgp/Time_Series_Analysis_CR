...
def log_error(request_info, error_message):
    print(f"Error retrieving data for request: {request_info}")
        ...
        for sensor_and_algorithm in sensor_and_algorithm_list:
            ...
            try:
                ...
                try:
                    ...
                    log_error(request, f"Failed to remove temporary file: {str(e)}")
