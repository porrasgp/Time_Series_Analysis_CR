        ...
        if 'Contents' in objects:
            for obj in objects['Contents']:
                ...
                if s3_key.endswith('.zip'):
                    ...
                    # Procesar archivos NetCDF en la carpeta temporal
                    yield temp_dir
...
def process_year_folder(year, variable):
    ...
    data_dfs = []
    for temp_dir in download_and_extract_from_s3(s3_prefix):
...
# Procesar los archivos por carpeta en paralelo usando ThreadPoolExecutor
